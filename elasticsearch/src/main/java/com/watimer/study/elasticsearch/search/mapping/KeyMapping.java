package com.watimer.study.elasticsearch.search.mapping;

import com.watimer.study.elasticsearch.ElasticsearchApplication;
import com.watimer.study.elasticsearch.model.FieldDefinition;
import com.watimer.study.elasticsearch.model.Key;
import com.watimer.study.elasticsearch.search.annotation.DefinitionQuery;
import com.watimer.study.elasticsearch.search.annotation.DefinitionQueryRepeatable;
...
public class KeyMapping {
    ...
    // 启动类所在包
    private static final String BOOTSTRAP_PATH = ElasticsearchApplication.class.getPackage().getName();
